      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
        ...
        <div className="perspective-2000 flex justify-center lg:justify-start">
          <motion.div 
            ...
            className="relative w-[350px] md:w-[420px] bg-white rounded-[3rem] p-1 shadow-[0_40px_100px_rgba(0,0,0,0.8)] group"
          >
            <div className="relative bg-[#ffffff] rounded-[2.9rem] h-full p-8 flex flex-col overflow-hidden">
              ...
              {/* CORE LANGUAGES GRID WITH COLOR REVEAL */}
              <div className="mb-2">
                ...
                <div className="grid grid-cols-4 gap-4">
                    {languages.map((lang) => (
                        ...
                        >
                            ...
                            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 translate-y-full opacity-0 group-hover/item:opacity-100 transition-all">
              ...
              {/* ARCHITECTURE FIELDS WITH YELLOW BORDER HOVER */}
